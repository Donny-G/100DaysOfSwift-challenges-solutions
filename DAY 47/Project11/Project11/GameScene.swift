...
//  Project11
//
//  Created by DeNNiO   G on 26/05/2019.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var ballsArray = ["ballRed", "ballGrey", "ballCyan", "ballBlue", "ballYellow", "ballPurple", "ballGreen"]
    ...
    override func didMove(to view: SKView) {
        ...
        numberOfBallsLabel.text = "Balls: 0"
        numberOfBallsLabel.horizontalAlignmentMode = .right
        numberOfBallsLabel.position = CGPoint(x: 700, y: 700)
